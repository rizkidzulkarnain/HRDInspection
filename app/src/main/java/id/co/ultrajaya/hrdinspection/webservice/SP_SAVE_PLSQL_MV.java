package id.co.ultrajaya.hrdinspection.webservice;
...
/**
 * Created by Aris on 25/11/2016.
 */

public class SP_SAVE_PLSQL_MV {
    private Object resultsRequestSOAP = null;
    private static final String SOAP_ACTION = "http://tempuri.org/SP_SAVE_PLSQL_MV";
    private static final String METHOD_NAME= "SP_SAVE_PLSQL_MV";
